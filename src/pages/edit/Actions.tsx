  ...
  return (
    <div className="3xl:text-[1.5em] 3xl:gap-3 flex flex-col gap-2 leading-none order-3 py-2">
      ...
      >
        ...
        {cartCount > 0 && (
          <span className="3xl:text-3xl 3xl:h-8 3xl:w-8 outline-2 outline-white absolute -top-2 -right-2 bg-main-cl text-white text-xs font-medium rounded-full w-6 h-6 flex items-center justify-center">
            {cartCount}
          </span>
        )}
      </button>
