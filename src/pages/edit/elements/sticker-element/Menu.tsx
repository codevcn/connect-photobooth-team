      ...
      >
        ...
        <div className="5xl:h-14 smd:col-span-1 smd:h-full 2xl:h-8 2xl:col-span-3 col-span-3 h-8 flex items-center">
          <button
            ...
            className="smd:h-full smd:px-1 2xl:h-full group h-full px-3 w-full cursor-pointer flex flex-nowrap items-center justify-center shadow-md font-bold bg-main-cl gap-1 text-white mobile-touch rounded"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
