  ...
  return (
    ...
    >
      <div className="relative bottom-5">
        <div className="STYLE-animation-loading-shapes text-main-cl"></div>
...
export const PageLoading = ({ message }: TPageLoadingProps) => {
  return (
    <div id="page-loading" className="flex flex-col items-center justify-center h-screen w-screen">
      <div className="relative bottom-5">
        <div className="STYLE-animation-loading-shapes text-main-cl"></div>
        <p className="QUERY-loading-message text-main-cl w-max text-lg font-bold mt-6 absolute top-[calc(50%+50px)] left-1/2 -translate-x-1/2 -translate-y-1/2">
          {message}
        </p>
      </div>
    </div>
